...
class LD_Score_Regression(object):
    ...
    def __init__(self, y, x, w, N, M, n_blocks, intercept=None, slow=False, step1_ii=None, 
        ...
        if loco and step1_ii is not None:
            raise ValueError(
                'LOCO cannot be used with a two-step estimator')
        if step1_ii is not None and self.constrain_intercept:
            ...
            if loco and (not self.constrain_intercept):
...
class Hsq(LD_Score_Regression):
    ...
    def __init__(self, y, x, w, N, M, n_blocks=200, intercept=None, slow=False, 
        ...
        LD_Score_Regression.__init__(self, y, x, w, N, M, n_blocks, intercept=intercept,
                                     ...
                                     standardize_ridge=standardize_ridge,
                                     approx_ridge=approx_ridge,
                                     skip_ridge_jackknife=skip_ridge_jackknife,
